...
4. [How it works](#4-functionality---how-the-bias--disparity-detection-engine-works-with-the-open-sentencing-solution)
5. [Architecture Diagrams](#5-architecture----bias--disparity-detection-engine-process-flow)
