...
2.	Without validated and benchmarked models for consistent attribution of implicit racial bias, solutions like CFCRJ Open Sentencing might have diminished ability to deliver the insight and outcomes users need in order to minimize the impact of disparity and bias in outcomes for their clients.
